...
public class LeftMenuAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if(mSelectedNum==position){
            ...
            viewHolder.menuName.setTextSize(16);
            viewHolder.viewLine.setVisibility(View.VISIBLE);
            viewHolder.menuName.setTextColor(mContext.getResources().getColor(R.color.colorMain));
        }else{
            viewHolder.menuName.setTextSize(14);
            viewHolder.viewLine.setVisibility(View.INVISIBLE);
            viewHolder.menuName.setTextColor(mContext.getResources().getColor(R.color.colorLine));
